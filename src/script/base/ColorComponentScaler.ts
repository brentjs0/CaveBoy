...
import { FiveBitNumber, isFiveBitNumber } from '../data/game-literal/FiveBitNumber';
...
export const factorOfEightScaler : ColorComponentScaler = {
    convertFiveBitToEightBit(fiveBitNumber: FiveBitNumber): EightBitNumber {
        ...
        throw new CaveBoyError(`FiveBitNumber '${fiveBitNumber}' could not be converted to an EightBitNumber.`);
    },
    convertEightBitToFiveBit(eightBitNumber: EightBitNumber): FiveBitNumber {
        ...
        throw new CaveBoyError(`EightBitNumber '${eightBitNumber}' could not be converted to a FiveBitNumber.`);
    }
} as const;
 ...
 */
export const colorComponentScalers: { [name in ColorComponentScalerNames]: ColorComponentScaler } = {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
...
export function getConfiguredColorComponentScaler(): ColorComponentScaler {
    const configuredScalerName: ColorComponentScalerNames = ((window as any).caveBoyConfiguration as CaveBoyConfiguration).colorComponentScalerName;
