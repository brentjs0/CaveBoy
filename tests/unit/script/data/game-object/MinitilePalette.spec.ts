...
describe('MinitilePalette', function () {
  describe('constructor()', function () {
    ...
    it('Creates an empty instance with default colors.', function () {
      ...
      expect(minitilePalette.colors).to.eql(defaultColors);
    });
  });
  ...
  describe('toCoilSnakeMinitilePaletteString()', function () {
    it('Generates a valid CoilSnakeMinitilePaletteString.', function () {
      const minitilePalette = new MinitilePalette();
      minitilePalette.colors[0] = new Color(0, 0, 0); // 000
      minitilePalette.colors[1] = new Color(19, 19, 6); // jj6
      minitilePalette.colors[2] = new Color(20, 20, 8); // kk8
      minitilePalette.colors[3] = new Color(16, 16, 6); // gg6
      minitilePalette.colors[4] = new Color(12, 12, 4); // cc4
      minitilePalette.colors[5] = new Color(8, 8, 3); // 883
      minitilePalette.colors[6] = new Color(11, 11, 12); // bbc
      minitilePalette.colors[7] = new Color(17, 24, 13); // hod
      minitilePalette.colors[8] = new Color(10, 16, 12); // agc
      minitilePalette.colors[9] = new Color(26, 25, 20); // qpk
      minitilePalette.colors[10] = new Color(23, 22, 15); // nmf
      minitilePalette.colors[11] = new Color(21, 20, 12); // lkc
      minitilePalette.colors[12] = new Color(19, 17, 9); // jh9
      minitilePalette.colors[13] = new Color(17, 16, 7); // hg7
      minitilePalette.colors[14] = new Color(4, 4, 3); // 443
      minitilePalette.colors[15] = new Color(0, 0, 0); // 000

      const coilSnakeMinitilePaletteString = minitilePalette.toCoilSnakeMinitilePaletteString();
