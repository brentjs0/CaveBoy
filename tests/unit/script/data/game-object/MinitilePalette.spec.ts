...
import { setUpCanvas } from '../../../../browser/test-methods';
...
describe('MinitilePalette', function () {
  ...
  describe('getPreviewImageData()', function () {
    ...
    it('Draws the colors correctly using the FactorOfEight scaler.', function () {
      const cbImageData = new MinitilePalette(
        '000jj6kk8gg6cc4883bbchodagcqpknmflkcjh9hg7443000'
      ).getPreviewImageData(ColorComponentScalerNames.FactorOfEight);

      const expectedDataValue = new Uint8ClampedArray([
        ...new Color(0, 0, 0).toUint8ClampedArray(
          255,
          ColorComponentScalerNames.FactorOfEight
        ), // 000
        ...new Color(19, 19, 6).toUint8ClampedArray(
          255,
          ColorComponentScalerNames.FactorOfEight
        ), // jj6
        ...new Color(20, 20, 8).toUint8ClampedArray(
          255,
          ColorComponentScalerNames.FactorOfEight
        ), // kk8
        ...new Color(16, 16, 6).toUint8ClampedArray(
          255,
          ColorComponentScalerNames.FactorOfEight
        ), // gg6
        ...new Color(12, 12, 4).toUint8ClampedArray(
          255,
          ColorComponentScalerNames.FactorOfEight
        ), // cc4
        ...new Color(8, 8, 3).toUint8ClampedArray(
          255,
          ColorComponentScalerNames.FactorOfEight
        ), // 883
        ...new Color(11, 11, 12).toUint8ClampedArray(
          255,
          ColorComponentScalerNames.FactorOfEight
        ), // bbc
        ...new Color(17, 24, 13).toUint8ClampedArray(
          255,
          ColorComponentScalerNames.FactorOfEight
        ), // hod
        ...new Color(10, 16, 12).toUint8ClampedArray(
          255,
          ColorComponentScalerNames.FactorOfEight
        ), // agc
        ...new Color(26, 25, 20).toUint8ClampedArray(
          255,
          ColorComponentScalerNames.FactorOfEight
        ), // qpk
        ...new Color(23, 22, 15).toUint8ClampedArray(
          255,
          ColorComponentScalerNames.FactorOfEight
        ), // nmf
        ...new Color(21, 20, 12).toUint8ClampedArray(
          255,
          ColorComponentScalerNames.FactorOfEight
        ), // lkc
        ...new Color(19, 17, 9).toUint8ClampedArray(
          255,
          ColorComponentScalerNames.FactorOfEight
        ), // jh9
        ...new Color(17, 16, 7).toUint8ClampedArray(
          255,
          ColorComponentScalerNames.FactorOfEight
        ), // hg7
        ...new Color(4, 4, 3).toUint8ClampedArray(
          255,
          ColorComponentScalerNames.FactorOfEight
        ), // 443
        ...new Color(0, 0, 0).toUint8ClampedArray(
